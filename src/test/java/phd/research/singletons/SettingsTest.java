...
public class SettingsTest {
    ...
    public void setUp() throws IOException {
        ...
        this.settings.setApkFile(new File(SettingsTest.workingDirectory + File.separator + "ActivityLifecycle.apk"));
        this.settings.setCallGraphFile(
                new File(SettingsTest.workingDirectory + File.separator + "ActivityLifecycle.gml"));
        this.settings.setOutputDirectory(new File(SettingsTest.workingDirectory));
    }
    ...
    public void testOutputUpdate() throws IOException {
        ...
        assertTrue("FlowDroid callback file not updated with output directory.",
                this.settings.getFlowDroidCallbacksFile().getAbsolutePath().contains(SettingsTest.workingDirectory)
                  );
    }
    ...
    public void testSetImportControlFlowGraph() throws IOException {
        ...
        this.settings.setImportControlFlowGraph(
                new File(SettingsTest.workingDirectory + File.separator + "ActivityLifecycle.json"));
    ...
    public void testSetPlatformDirectory() throws IOException {
        ...
        this.settings.setPlatformDirectory(new File(SettingsTest.workingDirectory));
        assertEquals("Wrong platform directory returned after change.", SettingsTest.workingDirectory,
                this.settings.getPlatformDirectory().getAbsolutePath()
                    );
    }
