...
public class MenuFileParser extends AbstractResourceParser {
    ...
    private final boolean loadOnlySensitiveControls = false;
    private SootClass scViewGroup = null;
    private SootClass scView = null;
    private SootClass scWebView = null;

    private LayoutControlFactory controlFactory = new MenuControlFactory();

    public MenuFileParser(String packageName, ARSCFileParser resParser) {
    ...
    /**
     * Parses all layout XML files in the given APK file and loads the IDs of the user controls in it. This method only
     * registers a Soot phase that is run when the Soot packs are next run
     *
     ...
     * directly executes the analyses witout registering any Soot phases.
     *
     * @param fileName The APK file in which to look for user controls
     */
    ...
    /**
     * Gets the user controls found in the layout XML file. The result is a mapping from the id to the respective layout
     * control.
     *
    ...
    /**
     * Gets the callback methods found in the layout XML file. The result is a mapping from the file name to the set of
     * found callback methods.
     *
    ...
    /**
     * Gets the fragments found in the layout XML file. The result is a mapping from the activity class to the set of
     * found fragments ids.
     *
    ...
    /**
     * Gets whether this analysis shall only collect sensitive controls such as password fields
     *
     * @return True if this analysis shall only collect sensitive controls, otherwise false
     */
